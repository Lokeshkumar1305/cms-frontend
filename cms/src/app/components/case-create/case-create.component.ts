...
export class CaseCreateComponent implements OnInit {
  ...
  depthBadgeStyle(depth: number): { [key: string]: string } {
    ...
    return { background: bg, color, border: `1px solid ${color}40`, 'border-radius': '20px', padding: '2px 8px', 'font-size': '10px', 'font-weight': '700', 'text-transform': 'uppercase', 'white-space': 'nowrap', 'flex-shrink': '0' };
  }
